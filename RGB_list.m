% This is an auxiliary function that helps to
% map species persistence into a colormap for heatmaps
% and scatter (aka banana) plots
function RGB_triplet = RGB_list()
    RGB_triplet = [0.2422    0.1504    0.6603;...
